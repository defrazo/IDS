function toDecreaseFont() { //Уменьшение шрифта
	...
	newSize = parseInt(fontSize);
	if (newSize == '32')	$('.designation').css('font-size', '30px');
	if (newSize == '30')	$('.designation').css('font-size', '28px');
	if (newSize == '28')	$('.designation').css('font-size', '26px');
	if (newSize == '26')	$('.designation').css('font-size', '24px');
	if (newSize == '24')	$('.designation').css('font-size', '22px');
	...
	if (newSize == '16')	$('.timer').css('padding', '14px');
	if (newSize == '14')	$('.timer').css('padding', '12px');
	if (newSize == '12')	$('.timer').css('padding', '10px');

	fontSize = $('.numbers').css('font-size');
	newSize = parseInt(fontSize);
	if (newSize == '56')	$('.numbers').css('font-size', '52px');
	if (newSize == '52')	$('.numbers').css('font-size', '48px');
	if (newSize == '48')	$('.numbers').css('font-size', '44px');
	if (newSize == '44')	$('.numbers').css('font-size', '40px');
	if (newSize == '40')	$('.numbers').css('font-size', '36px');
