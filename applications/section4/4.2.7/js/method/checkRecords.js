...
$(document).ready(function() { 
	$('#i11').focusout(function() {
		...
		if (i11 != '') {
			...
			if (isValidI11(i11)) $('#i11').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i12').focusout(function() {
		...
		if (i12 != '') {
			...
			if (isValidI12(i12)) $('#i12').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i21').focusout(function() {
		...
		if (i21 != '') {
			...
			if (isValidI21(i21)) $('#i21').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i22').focusout(function() {
		...
		if (i22 != '') {
			...
			if (isValidI22(i22)) $('#i22').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i31').focusout(function() {
		...
		if (i31 != '') {
			...
			if (isValidI31(i31)) $('#i31').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i32').focusout(function() {
		...
		if (i32 != '') {
			...
			if (isValidI32(i32)) $('#i32').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i41').focusout(function() {
		...
		if (i41 != '') {
			...
			if (isValidI41(i41)) $('#i41').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i42').focusout(function() {
		...
		if (i42 != '') {
			...
			if (isValidI42(i42)) $('#i42').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i51').focusout(function() {
		...
		if (i51 != '') {
			...
			if (isValidI51(i51)) $('#i51').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i52').focusout(function() {
		...
		if (i52 != '') {
			...
			if (isValidI52(i52)) $('#i52').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i61').focusout(function() {
		...
		if (i61 != '') {
			...
			if (isValidI61(i61)) $('#i61').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i62').focusout(function() {
		...
		if (i62 != '') {
			...
			if (isValidI62(i62)) $('#i62').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i71').focusout(function() {
		...
		if (i71 != '') {
			...
			if (isValidI71(i71)) $('#i71').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i72').focusout(function() {
		...
		if (i72 != '') {
			...
			if (isValidI72(i72)) $('#i72').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i81').focusout(function() {
		...
		if (i81 != '') {
			...
			if (isValidI81(i81)) $('#i81').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i82').focusout(function() {
		...
		if (i82 != '') {
			...
			if (isValidI82(i82)) $('#i82').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i91').focusout(function() {
		...
		if (i91 != '') {
			...
			if (isValidI91(i91)) $('#i91').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i92').focusout(function() {
		...
		if (i92 != '') {
			...
			if (isValidI92(i92)) $('#i92').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i101').focusout(function() {
		...
		if (i101 != '') {
			...
			if (isValidI101(i101)) $('#i101').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i102').focusout(function() {
		...
		if (i102 != '') {
			...
			if (isValidI102(i102)) $('#i102').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i111').focusout(function() {
		...
		if (i111 != '') {
			...
			if (isValidI111(i111)) $('#i111').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i112').focusout(function() {
		...
		if (i112 != '') {
			...
			if (isValidI112(i112)) $('#i112').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i121').focusout(function() {
		...
		if (i121 != '') {
			...
			if (isValidI121(i121)) $('#i121').css('border', '1px solid #0dd01a');
			else {
...
$(document).ready(function() { 
	$('#i122').focusout(function() {
		...
		if (i122 != '') {
			...
			if (isValidI122(i122)) $('#i122').css('border', '1px solid #0dd01a');
			else {
