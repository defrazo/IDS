$(document).ready(function() {
	...
	$('#value1').append(value1 + ' балл(ов). <br>' + value1s);
	$('#value2').append(value2 + ' балл(ов). <br>' + value2s);
	$('#value3').append(value3 + ' балл(ов). <br>' + value3s);
	$('#value4').append(value4 + ' балл(ов). <br>' + value4s);
	$('#value5').append(value5 + ' балл(ов). <br>' + value5s);
	$('#fac').append(fac);
});