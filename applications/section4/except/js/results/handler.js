$(document).ready(function() {
	...
	value = parseInt(q1) + parseInt(q2) + parseInt(q3) + parseInt(q4) + parseInt(q5) + parseInt(q6) + parseInt(q7) + parseInt(q8) + parseInt(q9) + parseInt(q10) + parseInt(q11) + parseInt(q12) + parseInt(q13) + parseInt(q14) + parseInt(q15) + parseInt(q16) + parseInt(q17);
	console.log(value);

	switch (true) {
		case (value <= 8) : status = 'Очень низкий'; break;
		case ((value >= 9) && (value <= 10)) : status = 'Низкий'; break;
		case ((value >= 11) && (value <= 13)) : status = 'Средний'; break;
		case ((value >= 14) && (value <= 15)) : status = 'Высокий'; break;
		case (value >= 16) : status = 'Очень высокий'; break;
	}
