$(document).ready(function() {
	...
	value1 = parseInt(q1) + parseInt(q7) + parseInt(q13) + parseInt(q19) + parseInt(q25) + parseInt(q31);
	value2 = parseInt(q2) + parseInt(q8) + parseInt(q14) + parseInt(q20) + parseInt(q26) + parseInt(q32);
	value3 = parseInt(q3) + parseInt(q9) + parseInt(q15) + parseInt(q21) + parseInt(q27) + parseInt(q33);
	value4 = parseInt(q4) + parseInt(q10) + parseInt(q16) + parseInt(q22) + parseInt(q28) + parseInt(q34);
	value5 = parseInt(q5) + parseInt(q11) + parseInt(q17) + parseInt(q23) + parseInt(q29) + parseInt(q35);
	value6 = parseInt(q6) + parseInt(q12) + parseInt(q18) + parseInt(q24) + parseInt(q30) + parseInt(q36);

	valpercent1 = (16.66 * value1).toFixed();
	valpercent2 = (16.66 * value2).toFixed();
	valpercent3 = (16.66 * value3).toFixed();
	valpercent5 = (16.66 * value5).toFixed();
	valpercent6 = (16.66 * value6).toFixed();

	sum = value1 + value2 + value3 + value4 + value5 + value6;

	switch (true) {
		case (sum <= 14) : status = 'Очень низкий'; break;
		case ((sum >= 15) && (sum <= 21)) : status = 'Заниженный'; break;
		case ((sum >= 22) && (sum <= 29)) : status = 'Средний'; break;
		case (sum >= 30): status = 'Высокий'; break;
	}
