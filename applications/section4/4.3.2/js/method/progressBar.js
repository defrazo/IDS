$(document).on('ready click focuson focusout mousemove', function() {
	...
	if (numValid == 21) {
		...
		progressMessage.text('Прогресс: 67.2%');
	}

	if (numValid == 22) {
		progress.css('width', '70.4%');
		progress.attr('aria-valuenow', '70.4');
		progressMessage.text('Прогресс: 70.4%');
	}
