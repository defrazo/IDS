...
$(document).ready(function() { 
	$('#f11').focusout(function() {
		...
		if (q11 != '') {
			...
			if (isValidQ11(q11)) {
				$('#f11').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f12').focusout(function() {
		...
		if (q12 != '') {
			...
			if (isValidQ12(q12)) {
				$('#f12').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f21').focusout(function() {
		...
		if (q21 != '') {
			...
			if (isValidQ21(q21)) {
				$('#f21').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f22').focusout(function() {
		...
		if (q22 != '') {
			...
			if (isValidQ22(q22)) {
				$('#f22').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f31').focusout(function() {
		...
		if (q31 != '') {
			...
			if (isValidQ31(q31)) {
				$('#f31').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f32').focusout(function() {
		...
		if (q32 != '') {
			...
			if (isValidQ32(q32)) {
				$('#f32').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f41').focusout(function() {
		...
		if (q41 != '') {
			...
			if (isValidQ41(q41)) {
				$('#f41').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f42').focusout(function() {
		...
		if (q42 != '') {
			...
			if (isValidQ42(q42)) {
				$('#f42').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f51').focusout(function() {
		...
		if (q51 != '') {
			...
			if (isValidQ51(q51)) {
				$('#f51').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f52').focusout(function() {
		...
		if (q52 != '') {
			...
			if (isValidQ52(q52)) {
				$('#f52').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f61').focusout(function() {
		...
		if (q61 != '') {
			...
			if (isValidQ61(q61)) {
				$('#f61').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f62').focusout(function() {
		...
		if (q62 != '') {
			...
			if (isValidQ62(q62)) {
				$('#f62').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f71').focusout(function() {
		...
		if (q71 != '') {
			...
			if (isValidQ71(q71)) {
				$('#f71').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f72').focusout(function() {
		...
		if (q72 != '') {
			...
			if (isValidQ72(q72)) {
				$('#f72').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f81').focusout(function() {
		...
		if (q81 != '') {
			...
			if (isValidQ81(q81)) {
				$('#f81').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f82').focusout(function() {
		...
		if (q82 != '') {
			...
			if (isValidQ82(q82)) {
				$('#f82').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f91').focusout(function() {
		...
		if (q91 != '') {
			...
			if (isValidQ91(q91)) {
				$('#f91').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f92').focusout(function() {
		...
		if (q92 != '') {
			...
			if (isValidQ92(q92)) {
				$('#f92').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f101').focusout(function() {
		...
		if (q101 != '') {
			...
			if (isValidQ101(q101)) {
				$('#f101').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f102').focusout(function() {
		...
		if (q102 != '') {
			...
			if (isValidQ102(q102)) {
				$('#f102').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f111').focusout(function() {
		...
		if (q111 != '') {
			...
			if (isValidQ111(q111)) {
				$('#f111').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f112').focusout(function() {
		...
		if (q112 != '') {
			...
			if (isValidQ112(q112)) {
				$('#f112').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f121').focusout(function() {
		...
		if (q121 != '') {
			...
			if (isValidQ121(q121)) {
				$('#f121').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f122').focusout(function() {
		...
		if (q122 != '') {
			...
			if (isValidQ122(q122)) {
				$('#f122').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f131').focusout(function() {
		...
		if (q131 != '') {
			...
			if (isValidQ131(q131)) {
				$('#f131').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f132').focusout(function() {
		...
		if (q132 != '') {
			...
			if (isValidQ132(q132)) {
				$('#f132').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f141').focusout(function() {
		...
		if (q141 != '') {
			...
			if (isValidQ141(q141)) {
				$('#f141').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f142').focusout(function() {
		...
		if (q142 != '') {
			...
			if (isValidQ142(q142)) {
				$('#f142').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f151').focusout(function() {
		...
		if (q151 != '') {
			...
			if (isValidQ151(q151)) {
				$('#f151').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f152').focusout(function() {
		...
		if (q152 != '') {
			...
			if (isValidQ152(q152)) {
				$('#f152').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f161').focusout(function() {
		...
		if (q161 != '') {
			...
			if (isValidQ161(q161)) {
				$('#f161').css('border', '1px solid #0dd01a');
...
$(document).ready(function() { 
	$('#f162').focusout(function() {
		...
		if (q162 != '') {
			...
			if (isValidQ162(q162)) {
				$('#f162').css('border', '1px solid #0dd01a');
