...
$(document).ready(function() { //Проверка ввода возраста
	$('#t1').focusout(function() {
		...
		if (t1 != '') {
			...
			if (isValidt1(t1)) {
				$('#t1').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt1(valt1) {
	if ($('#t1').val().length == 2) { //Проверяет при длине значения = 2
...
$(document).ready(function() { //Проверка ввода возраста
	$('#t2').focusout(function() {
		...
		if (t2 != '') {
			...
			if (isValidt2(t2)) {
				$('#t2').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt2(valt2) {
	if ($('#t2').val().length == 2) { //Проверяет при длине значения = 2
		var pattern = new RegExp(/[0-9][0-9]/);
...
$(document).ready(function() { //Проверка ввода возраста
	$('#t3').focusout(function() {
		...
		if (t3 != '') {
			...
			if (isValidt3(t3)) {
				$('#t3').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt3(valt3) {
	...
	if ($('#t3').val().length == 2) { //Проверяет при длине значения = 2
		var pattern = new RegExp(/[0-9][0-9]/);
...
$(document).ready(function() { //Проверка ввода возраста
	$('#t4').focusout(function() {
		...
		if (t4 != '') {
			...
			if (isValidt4(t4)) {
				$('#t4').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt4(valt4) {
	...
	if ($('#t4').val().length == 2) { //Проверяет при длине значения = 2
		var pattern = new RegExp(/[0-9][0-9]/);
...
$(document).ready(function() { //Проверка ввода возраста
	$('#t5').focusout(function() {
		...
		if (t5 != '') {
			...
			if (isValidt5(t5)) {
				$('#t5').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt5(valt5) {
	...
	if ($('#t5').val().length == 2) { //Проверяет при длине значения = 2
		var pattern = new RegExp(/[0-9][0-9]/);
...
$(document).ready(function() { //Проверка ввода возраста
	$('#t6').focusout(function() {
		...
		if (t6 != '') {
			...
			if (isValidt6(t6)) {
				$('#t6').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt6(valt6) {
	...
	if ($('#t6').val().length == 2) { //Проверяет при длине значения = 2
		var pattern = new RegExp(/[0-9][0-9]/);
...
$(document).ready(function() { //Проверка ввода возраста
	$('#t7').focusout(function() {
		...
		if (t7 != '') {
			...
			if (isValidt7(t7)) {
				$('#t7').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt7(valt7) {
	...
	if ($('#t7').val().length == 2) { //Проверяет при длине значения = 2
		var pattern = new RegExp(/[0-9][0-9]/);
...
$(document).ready(function() { //Проверка ввода возраста
	$('#t8').focusout(function() {
		...
		if (t8 != '') {
			...
			if (isValidt8(t8)) {
				$('#t8').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt8(valt8) {
	...
	if ($('#t8').val().length == 2) { //Проверяет при длине значения = 2
		var pattern = new RegExp(/[0-9][0-9]/);
...
$(document).ready(function() { //Проверка ввода возраста
	$('#t9').focusout(function() {
		...
		if (t9 != '') {
			...
			if (isValidt9(t9)) {
				$('#t9').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt9(valt9) {
	...
	if ($('#t9').val().length == 2) { //Проверяет при длине значения = 2
		var pattern = new RegExp(/[0-9][0-9]/);
...
$(document).ready(function() { //Проверка ввода возраста
	$('#t10').focusout(function() {
		...
		if (t10 != '') {
			...
			if (isValidt10(t10)) {
				$('#t10').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt10(valt10) {
	...
	if ($('#t10').val().length == 2) { //Проверяет при длине значения = 2
		var pattern = new RegExp(/[0-9][0-9]/);
...
$(document).ready(function() { //Проверка ввода возраста
	$('#t11').focusout(function() {
		...
		if (t11 != '') {
			...
			if (isValidt11(t11)) {
				$('#t11').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt11(valt11) {
	...
	if ($('#t11').val().length == 2) { //Проверяет при длине значения = 2
		var pattern = new RegExp(/[0-9][0-9]/);
...
$(document).ready(function() { //Проверка ввода возраста
	$('#t12').focusout(function() {
		...
		if (t12 != '') {
			...
			if (isValidt12(t12)) {
				$('#t12').css('border', '1px solid #0dd01a');
			} else {
...
function isValidt12(valt12) {
	...
	if ($('#t12').val().length == 2) { //Проверяет при длине значения = 2
		var pattern = new RegExp(/[0-9][0-9]/);
