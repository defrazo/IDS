$(document).on('ready mousemove change', function() {//Проверяет заполнение всех полей и выводит кнопку "Продолжить"
	...
	v5 = $("input[name=q4111]:checked").is(':checked'),
	v6 = $("input[name=q4112]:checked").is(':checked'),
	v7 = $("input[name=q4113]:checked").is(':checked'),
	v8 = $("input[name=q4114]:checked").is(':checked'),
	v9 = $("input[name=q4115]:checked").is(':checked'),
	v10 = $("input[name=q4116]:checked").is(':checked'),
	v11 = $("input[name=q4117]:checked").is(':checked'),
	v12 = $("input[name=q4118]:checked").is(':checked'),
	v13 = $("input[name=q4119]:checked").is(':checked'),
	v14 = $("input[name=q41110]:checked").is(':checked'),
	v15 = $("input[name=q41111]:checked").is(':checked'),
	v16 = $("input[name=q41112]:checked").is(':checked'),
	v17 = $("input[name=q41113]:checked").is(':checked'),
	v18 = $("input[name=q41114]:checked").is(':checked'),
	v19 = $("input[name=q41115]:checked").is(':checked'),
	v20 = $("input[name=q41116]:checked").is(':checked'),
	v21 = $('#date').val(),
	v22 = $('#fac').val();
