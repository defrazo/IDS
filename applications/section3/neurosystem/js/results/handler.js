$(document).ready(function() {
	...
	orto = Math.abs((ortopulseh - ortopulsev)).toFixed();
	...
	clino = Math.abs((clinopulsev - clinopulseh)).toFixed();
	clinopercent = ((clinopulsev / 100) * clino).toFixed(1);
