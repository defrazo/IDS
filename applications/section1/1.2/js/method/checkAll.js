$(document).on('ready mousemove change', function() {
	...
	if ($('input[name="gender"]:checked').val() == 'Мужской') {
		if ($('input[name="group"]:checked').val() == 'Основная') {
			if ((v1) && (v2) && (v3) && (v4) && (v5) && (v6) && (v7) && (v10) && 
				(v11) && (v12) && (v13) && (v14) && (v15) && (v16) && (v18) && (v19) && (v21)) {
			...
			if ((v1) && (v2) && (v3) && (v4) && (v5) && (v7) && (v8) && (v9) && (v10) && 
				(v11) && (v12) && (v13) && (v14) && (v15) && (v16) && (v19) && (v20) && (v21) && (v22)) {
				if ($('#method_submit').is(':hidden')) {
					$('#method_submit').css('display', 'block');
					$('#method_submit').removeClass('no_click');	
				}
		...
		if ($('input[name="group"]:checked').val() == 'Основная') {
			if ((v1) && (v2) && (v3) && (v4) && (v5) && (v6) && (v7) && (v10) && 
				(v11) && (v12) && (v13) && (v16) && (v17) && (v18) && (v19) && (v21)) {
				if ($('#method_submit').is(':hidden')) {
					$('#method_submit').css('display', 'block');
					$('#method_submit').removeClass('no_click');
				}
			...
			if ((!v1) || (!v2) || (!v3) || (!v4) || (!v5) || (!v6) || (!v7) || 
				(!v10) || (!v11) || (!v12) || (!v13) || (!v16) || (!v17) || (!v18) || (!v19) || (!v21)) {
				$('#method_submit').addClass('no_click');
				if ($('#method_submit').is(':visible')) $('#method_submit').css('display', 'none');
			}
		} else {
			if ((v1) && (v2) && (v3) && (v4) && (v5) && (v7) && (v8) && (v9) && 
				(v10) && (v11) && (v12) && (v13) && (v16) && (v17) && (v19) && (v20) && (v21) && (v22)) {
				if ($('#method_submit').is(':hidden')) {
					$('#method_submit').css('display', 'block');
					$('#method_submit').removeClass('no_click');	
				}
