...
function toIncreaseFont() { //Увеличение шрифта
	...
	newSize = parseInt(fontSize);
	if (newSize == '22')	{$('.designation b').css('font-size', '24px'); localStorage.setItem('des', '24px');}
	if (newSize == '24')	{$('.designation b').css('font-size', '26px'); localStorage.setItem('des', '26px');}
	if (newSize == '26')	{$('.designation b').css('font-size', '28px'); localStorage.setItem('des', '28px');}
