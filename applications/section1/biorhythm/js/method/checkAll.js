$(document).on('ready mousemove change', function() {//Проверяет заполнение всех полей и выводит кнопку "Продолжить"
	...
	v5 = $("input[name=q1]:checked").is(':checked'),
	v6 = $("input[name=q2]:checked").is(':checked'),
	v7 = $("input[name=q3]:checked").is(':checked'),
	v8 = $("input[name=q4]:checked").is(':checked'),
	v9 = $("input[name=q5]:checked").is(':checked'),
	v10 = $("input[name=q6]:checked").is(':checked'),
	v11 = $("input[name=q7]:checked").is(':checked'),
	v12 = $("input[name=q8]:checked").is(':checked'),
	v13 = $("input[name=q9]:checked").is(':checked'),
	v14 = $("input[name=q10]:checked").is(':checked'),
	v15 = $("input[name=q11]:checked").is(':checked'),
	v16 = $("input[name=q12]:checked").is(':checked'),
	v17 = $("input[name=q13]:checked").is(':checked'),
	v18 = $("input[name=q14]:checked").is(':checked'),
	v19 = $("input[name=q15]:checked").is(':checked'),
	v20 = $("input[name=q16]:checked").is(':checked'),
	v21 = $("input[name=q17]:checked").is(':checked'),
	v22 = $("input[name=q18]:checked").is(':checked'),
	v23 = $("input[name=q19]:checked").is(':checked'),
	v24 = $("input[name=q20]:checked").is(':checked'),
	v25 = $("input[name=q21]:checked").is(':checked'),
	v26 = $("input[name=q22]:checked").is(':checked'),
	v27 = $("input[name=q23]:checked").is(':checked'),
	v28 = $('#date').val(),
	v29 = $('#fac').val();

	if ((v1) && (v2) && (v3) && (v4) && (v5) && (v6) && (v7) && (v8) && (v9) && (v10) && (v11) && (v12) && (v13) && (v14) && (v15) && (v16) && (v17) && (v18) && (v19) && (v20) && (v21) && (v22) && (v23) && (v24) && (v25) && (v26) && (v27) && (v28) && (v29)) {
