$(document).ready(function() {
	...
	value = parseInt(q1) + parseInt(q2) + parseInt(q3) + parseInt(q4) + parseInt(q5) + parseInt(q6) + parseInt(q7) + parseInt(q8) + parseInt(q9) + parseInt(q10) + parseInt(q11) + parseInt(q12) + parseInt(q13) + parseInt(q14) + parseInt(q15) + parseInt(q16) + parseInt(q17) + parseInt(q18) + parseInt(q19) + parseInt(q20) + parseInt(q21) + parseInt(q22);

	switch (true) {
		case (value >= 60) : status = 'Высокий'; break;
		case ((value >= 40) && (value <= 59)) : status = 'Средний'; break;
		case ((value >= 20) && (value <= 39)) : status = 'Низкий'; break;
		case (value <= 19) : status = 'Очень низкий'; break;
	}
