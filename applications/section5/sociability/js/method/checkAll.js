$(document).on('ready mousemove change', function() {//Проверяет заполнение всех полей и выводит кнопку "Продолжить"
	...
	v5 = $("input[name=ac1]:checked").is(':checked'),
	v6 = $("input[name=ac2]:checked").is(':checked'),
	v7 = $("input[name=ac3]:checked").is(':checked'),
	v8 = $("input[name=ac4]:checked").is(':checked'),
	v9 = $("input[name=ac5]:checked").is(':checked'),
	v10 = $("input[name=ac6]:checked").is(':checked'),
	v11 = $("input[name=ac7]:checked").is(':checked'),
	v12 = $("input[name=ac8]:checked").is(':checked'),
	v13 = $("input[name=ac9]:checked").is(':checked'),
	v14 = $("input[name=ac10]:checked").is(':checked'),
	v15 = $("input[name=ac11]:checked").is(':checked'),
	v16 = $("input[name=ac12]:checked").is(':checked'),
	v17 = $("input[name=ac13]:checked").is(':checked'),
	v18 = $("input[name=ac14]:checked").is(':checked'),
	v19 = $("input[name=ac15]:checked").is(':checked'),
	v20 = $("input[name=ac16]:checked").is(':checked'),
	v21 = $('#date').val(),
	v22 = $('#fac').val();
