$(document).ready(function() {
	...
	switch (true) {
		case ((value >= 30) && (value <= 31)) : status = 'Низкий'; break;
		case ((value >= 25) && (value <= 29)) : status = 'Ниже среднего'; break;
		case ((value >= 19) && (value <= 24)) : status = 'Средний'; break;
		case ((value >= 14) && (value <= 18)) : status = 'Идеальный'; break;
		case ((value >= 9) && (value <= 13)) : status = 'Выше среднего (нежелательно)'; break;
		case ((value >= 4) && (value <= 8)) : status = 'Высокий (плохо)'; break;
		case (value <= 3) : status = 'Очень высокий (очень плохо)'; break;
	}
