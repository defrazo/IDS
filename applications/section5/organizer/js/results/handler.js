$(document).ready(function() {
	...
	value1 = parseInt(q1) + parseInt(q3) + parseInt(q5) + parseInt(q7) + parseInt(q9) + parseInt(q11) + parseInt(q13) + parseInt(q15) + parseInt(q17) + parseInt(q19) + parseInt(q21) + parseInt(q23) + parseInt(q25) + parseInt(q27) + parseInt(q29) + parseInt(q31) + parseInt(q33) + parseInt(q35) + parseInt(q37) + parseInt(q39);
	value2 = parseInt(q2) + parseInt(q4) + parseInt(q6) + parseInt(q8) + parseInt(q10) + parseInt(q12) + parseInt(q14) + parseInt(q16) + parseInt(q18) + parseInt(q20) + parseInt(q22) + parseInt(q24) + parseInt(q26) + parseInt(q28) + parseInt(q30) + parseInt(q32) + parseInt(q34) + parseInt(q36) + parseInt(q38) + parseInt(q40);
	kvalue1 = (0.05 * value1).toFixed(2);
	kvalue2 = (0.05 * value2).toFixed(2);

	switch (true) {
		case ((kvalue1 >= 0.10) && (kvalue1 <= 0.45)) : status1 = 'Низкий уровень'; break;
		case ((kvalue1 >= 0.46) && (kvalue1 <= 0.55)) : status1 = 'Уровень ниже среднего'; break;
		case ((kvalue1 >= 0.56) && (kvalue1 <= 0.65)) : status1 = 'Средний уровень'; break;
		case ((kvalue1 >= 0.66) && (kvalue1 <= 0.75)) : status1 = 'Высокий уровень'; break;
		case (kvalue1 >= 0.76) : status1 = 'Очень высокий уровень'; break;
	}

	switch (true) {
		case ((kvalue2 >= 0.20) && (kvalue2 <= 0.55)) : status2 = 'Низкий уровень'; break;
		case ((kvalue2 >= 0.56) && (kvalue2 <= 0.65)) : status2 = 'Уровень ниже среднего'; break;
		case ((kvalue2 >= 0.66) && (kvalue2 <= 0.70)) : status2 = 'Средний уровень'; break;
		case ((kvalue2 >= 0.71) && (kvalue2 <= 0.80)) : status2 = 'Высокий уровень'; break;
		case (kvalue2 >= 0.81) : status2 = 'Очень высокий уровень'; break;
	}
